...
int main()
{
    ...
    /*
    for(int i=0; i<mikkel.size(); i++){
        cout << "mikkel[" << i << "],";
    }
    cout << endl << endl;
    */
    //vector<float>& temp = mikkel;
    //vector<float>&& temp2 = temp;
    //fdeep::internal::float_vec&& temp = data[0];
    //float_vec&& values
    /*
    for(int i=0; i<mikkel.size();i++){
        cout << mikkel[i] << endl;
